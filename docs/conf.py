...
# -*- coding: utf-8 -*-
#
# xrootdlib documentation build configuration file, created by
...
from xrootdlib import __about__
...
htmlhelp_basename = 'xrootdlibdoc'
...
latex_documents = [
    (master_doc, 'xrootdlib.tex', 'xrootdlib Documentation',
     'Max Fischer', 'manual'),
]
...
man_pages = [
    (master_doc, 'xrootdlib', 'xrootdlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xrootdlib', 'xrootdlib Documentation',
     author, 'xrootdlib', 'One line description of project.',
     'Miscellaneous'),
]
