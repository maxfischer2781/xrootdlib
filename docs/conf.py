...
# -*- coding: utf-8 -*-
#
# chainlet documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'chainlet.tex', 'chainlet Documentation',
     'Max Fischer', 'manual'),
]
...
man_pages = [
    (master_doc, 'chainlet', 'chainlet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'chainlet', 'chainlet Documentation',
     author, 'chainlet', 'One line description of project.',
     'Miscellaneous'),
]
